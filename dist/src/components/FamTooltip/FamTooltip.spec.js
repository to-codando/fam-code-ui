...
// src/components/FamTooltip/FamTooltip.spec.ts
...
var template = /* @__PURE__ */ __name(() => html`
  <div class="wrap-ctx">
...
describe("FamTooltip", () => {
  ...
  it("Should ensure that the component has the correct properties", () => {
    f(FamTooltip()).to.have.all.keys(["template", "styles"]);
  });
  it("Should render tooltip content correctly", () => {
    ...
    f((_a = element == null ? void 0 : element.firstChild) == null ? void 0 : _a.textContent).to.equal(text);
  });
});
...
@esm-bundle/chai/esm/chai.js:
  ...
  *)
   ...
   *)
*/
//# sourceMappingURL=FamTooltip.spec.js.map
