...
// src/components/FamContainer/FamContainer.spec.ts
...
describe("FamContainer", () => {
  ...
  it("Should correctly render container text", () => {
    ...
    componentElement = (_a = document == null ? void 0 : document.body) == null ? void 0 : _a.querySelector("fam-container");
    const titleElement = componentElement == null ? void 0 : componentElement.querySelector("h1");
    f((_b = titleElement == null ? void 0 : titleElement.textContent) == null ? void 0 : _b.trim()).to.be.eql(containerText);
  });
});
...
@esm-bundle/chai/esm/chai.js:
  ...
  *)
   ...
   *)
*/
//# sourceMappingURL=FamContainer.spec.js.map
