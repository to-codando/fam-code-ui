...
// src/components/FamButton/FamButton.spec.ts
...
describe("FamButton", () => {
  ...
  it("Should ensure that the component has the correct properties", () => {
    f(FamButton()).to.have.all.keys(["template", "styles"]);
  });
  it("Should render button content correctly", () => {
    ...
    f((_a = element == null ? void 0 : element.firstChild) == null ? void 0 : _a.textContent).to.equal("Salvar");
  });
});
...
@esm-bundle/chai/esm/chai.js:
  ...
  *)
   ...
   *)
*/
//# sourceMappingURL=FamButton.spec.js.map
