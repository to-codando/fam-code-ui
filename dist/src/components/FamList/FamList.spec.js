...
// src/components/FamList/FamList.spec.ts
...
describe("FamList", () => {
  ...
  it("Should have template and style defined", () => {
    f(component).to.have.all.keys(["template", "styles"]);
  });
  it("Should correctly render data props", () => {
    ...
    const liData = (_a = Array.from(
      (componentElement == null ? void 0 : componentElement.querySelectorAll("li")) || []
    )) == null ? void 0 : _a.map((li) => li.textContent);
    f(liData).to.be.eql(data);
  });
});
...
@esm-bundle/chai/esm/chai.js:
  ...
  *)
   ...
   *)
*/
//# sourceMappingURL=FamList.spec.js.map
