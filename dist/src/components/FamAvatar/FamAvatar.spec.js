...
// src/components/FamAvatar/FamAvatar.spec.ts
...
describe("FamAvatar", () => {
  ...
  afterEach(() => {
    document.querySelectorAll("fam-image").forEach((FamAvatar2) => FamAvatar2.remove());
  });
  ...
  it("Should render correctly", () => {
    ...
    const image = componentElement == null ? void 0 : componentElement.querySelector("img");
    const imageSize = Array.from(image.classList)[0];
    const propsSize = `size-${props.size}`;
    f(!!image).to.be.true;
    f(image == null ? void 0 : image.src).to.be.contains(props.src);
    f(image == null ? void 0 : image.alt).to.be.contains(props.alt);
    f(imageSize).contains(propsSize);
  });
});
...
@esm-bundle/chai/esm/chai.js:
  ...
  *)
   ...
   *)
*/
//# sourceMappingURL=FamAvatar.spec.js.map
