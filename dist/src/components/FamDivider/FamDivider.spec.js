...
// src/components/FamDivider/FamDivider.spec.ts
...
describe("FamDivider", () => {
  ...
  it("Should correctly render the divider component type property", () => {
    ...
    componentElement = document == null ? void 0 : document.querySelector("fam-divider > div");
    const dividerType = componentElement == null ? void 0 : componentElement.getAttribute("type");
    f(dividerType).to.be.eql(type);
  });
  it("Should throw an exception when the divider type is invalid", () => {
    ...
    f(component.actions.validate(invalidType)).to.be.eql(error);
  });
});
...
@esm-bundle/chai/esm/chai.js:
  ...
  *)
   ...
   *)
*/
//# sourceMappingURL=FamDivider.spec.js.map
