...
var n = /* @__PURE__ */ __name(function(t3, s2, r2, e2) {
  var u2;
  s2[0] = 0;
  for (var h3 = 1; h3 < s2.length; h3++) {
    var p2 = s2[h3++], a2 = s2[h3] ? (s2[0] |= p2 ? 1 : 2, r2[s2[h3++]]) : s2[++h3];
    3 === p2 ? e2[0] = a2 : 4 === p2 ? e2[1] = Object.assign(e2[1] || {}, a2) : 5 === p2 ? (e2[1] = e2[1] || {})[s2[++h3]] = a2 : 6 === p2 ? e2[1][s2[++h3]] += a2 + "" : p2 ? (u2 = t3.apply(a2, n(t3, a2, r2, ["", null])), e2.push(u2), a2[0] ? s2[0] |= 2 : (s2[h3 - 2] = 0, s2[h3] = u2)) : e2.push(a2);
  }
  return e2;
}, "n");
...
// src/components/FamCheckBox/FamCheckBox.spec.ts
...
var o = n2.exports = function() {
  function e2(n3, o2, r2) {
    ...
    __name(i2, "i");
    for (var s2 = t2, a2 = 0; a2 < r2.length; a2++)
      i2(r2[a2]);
    return i2;
  }
  __name(e2, "e");
...
describe("FamCheckBox", () => {
  ...
  beforeEach(() => {
    const handler = /* @__PURE__ */ __name(() => isHandlerExecuted = true, "handler");
    render(
      html`
  ...
  it("Should ensure that the component has the correct properties", () => {
    f(FamCheckBox()).to.have.all.keys(["template", "styles"]);
  });
  it("Should render correctly component label ", () => {
    const labelElement = element == null ? void 0 : element.querySelector("span");
    f(labelElement == null ? void 0 : labelElement.textContent).to.equal(label);
  });
  it("Should render correctly checked input component", () => {
    const inputElement = element == null ? void 0 : element.querySelector("input");
    f(inputElement == null ? void 0 : inputElement.checked).to.equal(checked);
  });
  it("Should execute handler when input change", () => {
    const inputElement = element == null ? void 0 : element.querySelector("input");
    inputElement == null ? void 0 : inputElement.click();
    f(isHandlerExecuted).to.equal(true);
  });
});
...
@esm-bundle/chai/esm/chai.js:
  ...
  *)
   ...
   *)
*/
//# sourceMappingURL=FamCheckBox.spec.js.map
