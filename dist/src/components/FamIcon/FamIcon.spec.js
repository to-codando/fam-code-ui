...
// src/components/FamIcon/FamIcon.spec.ts
...
describe("FamIcon", () => {
  ...
  it("Should throw an error to empty properties ", () => {
    ...
    f(component.actions.validate(nameIcon)).to.be.eql(error);
    f(component.actions.validate(sizeIcon)).to.be.eql(error);
  });
  it("Should correctly render with not empty properties", () => {
    const nameIcon = "home";
    const sizeIcon = "size-2";
    f(component.actions.validate(nameIcon)).to.be.eql(null);
    f(component.actions.validate(sizeIcon)).to.be.eql(null);
  });
});
...
@esm-bundle/chai/esm/chai.js:
  ...
  *)
   ...
   *)
*/
//# sourceMappingURL=FamIcon.spec.js.map
